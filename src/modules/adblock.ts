...
const REGEX_DOMAIN = new RegExp(
    "^(([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9-]*[a-zA-Z0-9]).)*([A-Za-z0-9]|[A-Za-z0-9][A-Za-z0-9-]*[A-Za-z0-9])$"
);
const REGEX_IPV4 = new RegExp(
    "^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5]).){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$"
);
const REGEX_IPV6 = new RegExp(
...
const processLines = (lines: string): Observable<string> =>
    ...
    // Split whole text file into line by line array, then flatten the array
        ...
        // Splie each line further into chunk by whitespaces,
        // then flatten the array agaain
        map((i) => i.split(/\s+/)),
        mergeAll(),
